...
/plan Create a plan to make posts one component, so instead of clicking on the title or the image of a post to view it, you can click on the entire post to view it. Also align the images in the posts on the Home page under Featured Posts, so they are aligned in the same vertical position